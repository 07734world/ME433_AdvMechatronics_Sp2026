...
int main()
{
    ...
    while (true) {
        ...
        /*//sleep_ms(BTW_REG_SLEEP);  
        i2c_read_burst_blocking(i2c_default, ADDR, xReadAccelL, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, yReadAccelH, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, yReadAccelL, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, zReadAccelH, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, zReadAccelL, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, tempReadH, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, tempReadL, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, xReadGyroH, 1);
        //sleep_ms(BTW_REG_SLEEP);   
        i2c_read_burst_blocking(i2c_default, ADDR, xReadGyroL, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, yReadGyroH, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, yReadGyroL, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, zReadGyroH, 1);
        //sleep_ms(BTW_REG_SLEEP); 
        i2c_read_burst_blocking(i2c_default, ADDR, zReadGyroL, 1);
        //sleep_ms(BTW_REG_SLEEP); */
...
/*
        int16_t xAccel=HLcombine(xReadAccelH,xReadAccelL);
        int16_t yAccel=HLcombine(yReadAccelH,yReadAccelL);
        int16_t zAccel=HLcombine(zReadAccelH,zReadAccelL);
        int16_t Temp=HLcombine(tempReadH,tempReadL);
        int16_t xGyro=HLcombine(xReadGyroH,xReadGyroL);
        int16_t yGyro=HLcombine(yReadGyroH,yReadGyroL);
        int16_t zGyro=HLcombine(zReadGyroH,zReadGyroL);*/
        

        //xAccel=0.000061*xAccel;
        //yAccel=0.000061*yAccel;
        //zAccel=0.000061*zAccel;
